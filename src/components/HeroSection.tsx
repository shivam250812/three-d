...
//           {/* CHANGED: This line sets the 3D scene background to white */}
...
//         <motion.h2 className="text-5xl md:text-7xl font-light leading-tight tracking-tight max-w-4xl mx-auto" initial={{opacity:0,y:50}} whileInView={{opacity:1,y:0}} transition={{duration:0.8,ease:easeOut}} viewport={{once:false}}>
//           Precision <span className="font-italic ">CNC</span> Parts <br /> Shipped as Fast as Tomorrow
//         </motion.h2 >
//       </div>
...
const HeroSection = () => {
  return (
    <section className="h-screen w-full relative text-center pt-32 px-4 overflow-hidden">
      ...
      <div className="relative z-10 w-full">
        <motion.h2 className="text-5xl md:text-7xl font-light leading-tight tracking-tight max-w-4xl mx-auto">
      ...
      <div className="absolute bottom-8 left-1/2 -translate-x-1/2 z-10 w-full px-4 flex flex-col items-center">
        ...
        <button className="mt-7 px-7 py-3.5 bg-blue-500 text-white font-semibold rounded-md hover:bg-blue-600 shadow-lg flex items-center gap-3 mx-auto text-sm">
